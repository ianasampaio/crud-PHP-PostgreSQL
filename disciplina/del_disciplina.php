    ...
    <div class="container">
      ...
      <input type="hidden" name="numero_disciplina" id="numero_disciplina" value="<?php echo $result['numero_disciplina'];?>">
        ...
        <div class="col-4">
          ...
          <input type="number" name="creditos" id="creditos" class="form-control" value="<?php echo $result['creditos'];?>" readonly>
        </div>

        <div class="col-4">
          <label for="departamento">Departamento</label>
          <input type="text" name="departamento" id="departamento" class="form-control" value="<?php echo ucwords($result['departamento']);?>" readonly>
        </div>
