    ...
    <div class="container">
      ...
      <div class="col-4">
        ...
        <div class="col-4">
          ...
          <input type="text" name="semestre" id="semestre" class="form-control" value="<?php echo ucwords($result['semestre']);?>" readonly>
        </div>

        <div class="col-4">
          <label for="ano">Ano</label>
          <input type="number" name="ano" id="ano" class="form-control" value="<?php echo $result['ano'];?>" readonly>
        </div>

        <div class="col-4">
          <label for="professor">Professor(a)</label>
          <input type="text" name="professor" id="professor" class="form-control" value="<?php echo ucwords($result['professor']);?>" readonly>
        </div>
