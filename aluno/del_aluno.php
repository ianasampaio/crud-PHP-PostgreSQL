    ...
    <div class="container">
      ...
      <input type="hidden" name="numero_aluno" id="numero_aluno" value="<?php echo $result['numero_aluno'];?>">
        ...
        <div class="col-4">
          ...
          <input type="number" name="tipo_aluno" id="tipo_aluno" class="form-control" value="<?php echo $result['tipo_aluno'];?>" readonly>
        </div>

        <div class="col-4">
          <label for="curso">Curso</label>
          <input type="text" name="curso" id="curso" class="form-control" value="<?php echo ucwords($result['curso']);?>" readonly>
        </div>
