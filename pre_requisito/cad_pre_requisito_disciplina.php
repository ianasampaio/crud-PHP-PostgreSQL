        ...
        <table class="table table-striped">
          ...
          <tbody>
              ...
              <tr>
                ...
                <td>
                    <a href="cad_pre_requisito.php?numero_disciplina=<?php echo $d['numero_disciplina']; ?>&nome_disciplina=<?php echo $d['nome_disciplina'];?>" class="btn btn-warning">Escolher disciplina</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
