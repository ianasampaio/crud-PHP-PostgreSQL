...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container">
      <div class="col-md-11">
        <h2 class="title">Turmas disponíveis</h2>
      </div>
    </div>
    <div class="container">
      <a href="cad_matricula_aluno.php" class="btn btn-danger">Voltar</a>
    </div>  
        ...
        <table class="table table-striped">
          ...
          <tbody>
              ...
              <tr>
                ...
                <td>
                    <a href="processa_matricula.php?identificacao_turma=<?php echo $d['identificacao_turma']; ?>&numero_aluno=<?php echo $result['numero_aluno'];?>&enviarDados=CAD" class="btn btn-warning">Realizar matrícula</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
