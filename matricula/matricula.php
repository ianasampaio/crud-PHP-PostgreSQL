...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container">
      <a href="cad_matricula_aluno.php" class="btn btn-primary">Nova matricula</a>
      <a href="busca_matricula.php" class="btn btn-primary">Pesquisar</a>
        ...
        <table class="table table-striped">
          ...
          <tbody>
              ...
              <tr>
                ...
                <td>
                    <a href="alt_matricula.php?numero_aluno=<?php echo $m['numero_aluno']; ?>&identificacao_turma=<?php echo $m['identificacao_turma']; ?>" class="btn btn-warning">Alterar</a>
                    <a href="del_matricula.php?numero_aluno=<?php echo $m['numero_aluno']; ?>&identificacao_turma=<?php echo $m['identificacao_turma']; ?>" class="btn btn-danger">Excluir</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
